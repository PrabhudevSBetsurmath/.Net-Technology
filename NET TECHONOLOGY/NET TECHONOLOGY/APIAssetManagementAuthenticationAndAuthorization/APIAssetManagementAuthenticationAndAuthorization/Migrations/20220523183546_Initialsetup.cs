        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    Assigneduser = table.Column<string>(name: "Assigned user", type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book", x => x.SerialNo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SerialNo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HardwareName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    AssignedUser = table.Column<string>(name: "Assigned User", type: "nvarchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hardware", x => x.SerialNo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoftwareLicense", x => x.SerialNo);
                });
