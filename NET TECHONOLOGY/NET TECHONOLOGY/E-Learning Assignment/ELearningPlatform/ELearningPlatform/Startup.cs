...
namespace ELearningPlatform
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IGetFilesRepository, GetFilesOfLoggedInUserRepository>();
            services.AddScoped<IDownloadFileOfStudentRepository, DownloadFileOfStudentRepository>();
            ...
            services.AddScoped<IRecievedMessagesRepository, RecievedMessagesRepository>();
            services.AddScoped<IFilesOfStudentRepository, GetFilesOfStudentRepository>();
            services.AddScoped<IAdminRepository, AdminRepository>();
            services.AddScoped<ICalenderEventsRepository, CalenderEventsRepository>();
            services.AddScoped<IGetCalenderEventsRepository, GetCalenderEventsRepository>();
