    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();//The first call to UseSwagger is the one that adds the “JSON” serving capability to your app. 
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ELearningPlatform v1"));//The second call is what adds the actual HTML interface for Swagger. Nice and easy!
            }
